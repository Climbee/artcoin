...
unlocked to sign the Artcoin-Qt.app bundle.
...
allowing somebody to distribute a Artcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the artcoin-qt.exe file inside the installer had not been tampered with.
